...
<#--
  ...
  - href: link target URL
-->
<#macro folder_open_icon visibility href view path>
    <a href="${href}/<#if view == 'browse'>details<#else>browse</#if>${path}"><i class="pl-2 <#if visibility == "PRIVATE">fas<#else>far</#if> fa-folder-open text-body"></i></a>
</#macro>
